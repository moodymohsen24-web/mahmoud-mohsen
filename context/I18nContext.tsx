...
const enTranslations = {
    ...
    "experimentalTts.title": "Experimental Text-to-Speech",
    ...
    "home.hero.titlePart1": "Master",
    "home.hero.titlePart2": "Arabic Content",
    ...
    "settings.tabs.voices": "Voice Management",
    ...
    "voiceManagement.title": "Voice Management",
    "voiceManagement.subtitle": "Manage built-in and custom voices for Text-to-Speech.",
    "voiceManagement.addVoice": "Add New Voice",
    "voiceManagement.form.voiceId": "Voice ID",
    "voiceManagement.form.name": "Voice Name",
    "voiceManagement.form.language": "Languages",
    "voiceManagement.form.languagePlaceholder": "Languages (e.g. English, Arabic)",
    "voiceManagement.form.accent": "Accent",
    "voiceManagement.form.category": "Category",
    "voiceManagement.table.name": "Name",
    "voiceManagement.table.id": "Voice ID",
    "voiceManagement.table.language": "Languages",
    "voiceManagement.table.accent": "Accent",
    "voiceManagement.table.category": "Category",
    "voiceManagement.table.actions": "Actions",
    "voiceManagement.type.default": "Read-only",
    "voiceManagement.save": "Save",
    "voiceManagement.cancel": "Cancel",
    "voiceManagement.edit": "Edit",
    ...
    "planManagement.deleteConfirm": "Are you sure you want to delete this plan? This action cannot be undone.",
...
const arTranslations = {
    ...
    "home.hero.titlePart1": "أتقن",
    "home.hero.titlePart2": "المحتوى العربي",
    "home.hero.viewDemo": "شاهد العرض",
    ...
    "settings.tabs.voices": "إدارة الأصوات",
    ...
    "voiceManagement.title": "إدارة الأصوات",
    "voiceManagement.subtitle": "إدارة الأصوات المدمجة والمخصصة لتحويل النص إلى كلام.",
    "voiceManagement.addVoice": "إضافة صوت جديد",
    "voiceManagement.form.voiceId": "معرف الصوت (Voice ID)",
    "voiceManagement.form.name": "اسم الصوت",
    "voiceManagement.form.language": "اللغات",
    "voiceManagement.form.languagePlaceholder": "اللغات (مثال: الإنجليزية, العربية)",
    "voiceManagement.form.accent": "اللهجة",
    "voiceManagement.form.category": "الفئة",
    "voiceManagement.table.name": "الاسم",
    "voiceManagement.table.id": "معرف الصوت",
    "voiceManagement.table.language": "اللغات",
    "voiceManagement.table.accent": "اللهجة",
    "voiceManagement.table.category": "الفئة",
    "voiceManagement.table.actions": "الإجراءات",
    "voiceManagement.type.default": "للقراءة فقط",
    "voiceManagement.save": "حفظ",
    "voiceManagement.cancel": "إلغاء",
    "voiceManagement.edit": "تعديل",
